 ...
 */     
  ...
  */    
    public function renderAdditionalSearchUI($extension_type)
    {
        ...
        $prices = array(
            'items' => $prices_items,
            'caption' => $prices_control_caption
        );
        
        $json_repos = json_encode($repos);
        $json_prices = json_encode($prices);
        ...
        jQuery(document).ready(function()
        {
			...
			wprc.search.renderAdditionalUI($json_repos, $json_prices, '".$extension_type."');
			jQuery('.popular-tags a').click(function(){
