...
<?php if(empty($this->repository->repository_name)): ?>
    ...
    <p class="error"><?php printf(__('The repository %s was not found. Perhaps deleted?', 'installer'), $this->repository->repository_name) ?></p>
    
<?php else: ?>

    <p><?php 
        printf(__('Please enter the login details for %s', 'installer'), $this->repository->repository_name); ?>
    </p>
    ...
    <table align="center" style="margin-top:100px;">
        ...
        <tr>
            ...
            <td align="right">
                <input name="submit" style="float:left" class="button-primary" id='wprc-login-submit' type="submit" value="<?php _e('Login', 'installer') ?>" />
                <input name="cancel" style="float:right" class="button-primary" id='wprc-login-cancel' type="button" value="<?php _e('Cancel', 'installer') ?>" />
            </td>
        </tr>    
    </table>
    </form>
...
<div id="wprc_repository_login_success" style="display:none;margin-top:60px;" class="updated below-h2">
...
<div id="wprc_repository_login_fail" style="display:none;margin-top:60px;" class="error below-h2">
    <p></p>
</div>
