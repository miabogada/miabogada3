...
{
    define('WPRC_PLUGIN_URL',WP_PLUGIN_URL.'/'.WPRC_PLUGIN_FOLDER);
...
define('WPRC_TIMER_DEFAULT_PERIOD',30); //604800; //30 one week by default


// jquery 
define('WPRC_JQUERY_UI_THEME', 'smoothness');

define('WPRC_SKIP_BULK_DEACVTIVATION_REPORT',true);

// link to the compatibility server
//define('WPRC_SERVER_URL','http://localhost/compatibility_server/wp-content/plugins/wp-repository-server/wprs-entry.php?wprs_c=server&wprs_action=execute');
