 ...
 */ 
    ...
    {        
        ...
        {    
            ...
            $insert_array[] = "($id, '$name', '$endpoint_url', '$username', '$pass', '$authsalt', $enabled, 0)";
        }
 ...
 */    
    public function addRepository($repository_name, $repository_endpoint_url, $repository_username, $repository_password, $repository_enabled, $repository_types)
    {        
        $data = array(
 ...
 */    
    ...
    public function updateRepositoryNoLogin($repository_id, $repository_name, $repository_endpoint_url, $repository_enabled, $repository_types, $repository_deleted=0)
    {     
        $repo = $this->getRepositoryByField('id', $repository_id);
    ...
    function testLogin($repository_id, $username, $password, $plain=false){
        ...
        $request = wp_remote_post($repo->repository_endpoint_url, array( 'timeout' => 5, 'body' => $body_array) );
	...
	public function addUpdateRepositories(array $repos)
	{
		foreach ($repos as $repo)
		{
			...
			$val.=", 0";
			$this->wpdb->query("INSERT INTO {$this->repository_table} (id, repository_name, repository_endpoint_url, repository_username, repository_password,repository_authsalt, repository_enabled, repository_deleted) VALUES ($val)");
