 ...
 */ 
add_action('init', array($wprc_rc, 'onViewWPPage'));
// -------------------------------------------------------------------------
...
function wprc_ajax_fetch_list() {
	...
	if ($list_class=='WPRC_ThemeInstall_List_Table')
        $wp_list_table = WPRC_Loader::getWPRCThemeInstallListTable( 'theme-install' );
    else
