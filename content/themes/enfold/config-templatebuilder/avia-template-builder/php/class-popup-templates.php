		...
		protected function columns_visibility_toggle( array $element )
		{
			...
			if( true === $allow_order )
			{
				$c[] = array(
							...
							'desc'		=> __( 'Select position of column when switching to fullwidth - 0 based. Only used when &quot;Column Behaviour&quot; set to individual.', 'avia_framework' ),
							'id'		=> 'mobile_col_pos',
							'type'		=> 'select',
							'std'		=> 0,
							'lockable'	=> $lockable,
							'required'	=> array( 'mobile_display', 'equals', '' ),
							'subtype'	=> \AviaHtmlHelper::number_array( 0, 5, 1 )
						);
			}
