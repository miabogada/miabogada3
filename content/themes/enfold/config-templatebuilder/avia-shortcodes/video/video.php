			...
			function popup_elements()
			{
				...
				else if(avia_get_option('disable_mediaelement') != 'disable_mediaelement')
				{
					$text = __("Please link to an external video by URL",'avia_framework' )."<br/><br/>".
							...
							"<strong>http://www.youtube.com/watch?v=G0k3kHtyoqc</strong><br/><br/>"."<strong class='av-builder-note'>".									__("Using self hosted videos is currently disabled. You can enable it in Enfold &raquo; Performance",'avia_framework' )."</strong><br/>";
				...
				else if(avia_get_option('disable_video') != 'disable_video')
				{
					$text = __("Either upload a new video or choose an existing video from your media library",'avia_framework' )."<br/><br/>".
							__("Different Browsers support different file types (mp4, ogv, webm). If you embed a example.mp4 video the video player will automatically check if a example.ogv and example.webm video is available and display those versions in case its possible and necessary",'avia_framework' )."<br/><br/><strong class='av-builder-note'>".
