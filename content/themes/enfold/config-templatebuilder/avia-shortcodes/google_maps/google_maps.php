...
if ( !class_exists( 'avia_sc_gmaps' ) ) 
{
	class avia_sc_gmaps extends aviaShortcodeTemplate
	{
			...
			{
				if(isset($_POST['action']) && $_POST['action'] == "avia_ajax_av_google_map" )
				{
			...
			function extra_assets()
			{
				...
				wp_enqueue_script( 'avia-module-maps' , AviaBuilder::$path['pluginUrlRoot'].'avia-shortcodes/google_maps/google_maps.js' , array('avia-shortcodes'), false, TRUE );
